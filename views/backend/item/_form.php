...
<div class="item-form">
    ...
    <?= $form->field($model, 'lenght')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'place')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'f_square')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'type')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'extra_work')->textInput(['maxlength' => true]) ?>
